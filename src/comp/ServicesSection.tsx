  ...
  const services = [
    {
      ...
      description: "Fast, responsive websites built with Next.js, optimized for top Google rankings and exceptional user experience.",
      color: "from-blue-600 to-purple-600",
      features: ["Next.js Framework", "SEO Optimized", "Mobile Responsive", "Fast Loading"]
    },
    {
      icon: <Palette className="h-8 w-8" />,
      title: "Corporate Identity Design",
      description: "Complete branding solutions including logos, color schemes, and brand guidelines that reflect your company's values.",
    ...
    },
    {
      ...
      description: "Strategic business consulting to optimize operations, improve efficiency, and drive sustainable growth.",
    ...
    },
    {
      ...
      description: "Expert guidance for international e-commerce expansion, market entry strategies, and cross-border operations.",
      color: "from-blue-600 to-green-600",
      features: ["Market Analysis", "Export Strategy", "Compliance Guidance", "Platform Setup"]
    },
    {
      icon: <Truck className="h-8 w-8" />,
      title: "Shipping & Logistics",
      description: "Comprehensive logistics solutions to streamline your supply chain and optimize delivery operations.",
      color: "from-purple-600 to-blue-600",
      features: ["Supply Chain Optimization", "Shipping Solutions", "Inventory Management", "Cost Analysis"]
    },
    {
      ...
      features: ["Product Photography", "Video Production", "360° Views", "Lifestyle Shots"]
    },
    {
      icon: <Share2 className="h-8 w-8" />,
      title: "Social Media Design",
      description: "Engaging social media content and designs that build brand awareness and drive customer engagement.",
      color: "from-blue-600 to-purple-600",
      features: ["Content Creation", "Visual Design", "Brand Consistency", "Engagement Strategy"]
    },
    {
    ...
    },
    {
      ...
      description: "Strategic digital advertising campaigns across multiple platforms to maximize your ROI and reach.",
      color: "from-green-600 to-blue-600",
      features: ["PPC Campaigns", "Social Media Ads", "Display Advertising", "Performance Tracking"]
    }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Comprehensive digital solutions designed to transform your business and accelerate your growth in the modern marketplace.
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              <CardHeader className="pb-4">
                <div className={`w-16 h-16 bg-gradient-to-r ${service.color} rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-200`}>
        ...
        <div>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Choose the perfect package that fits your business needs and budget. All plans include our premium support and consultation.
            </p>
          </div>
              ...
              >
                ...
                <CardHeader className="text-center pb-6">
                  ...
                  <div className="flex items-baseline justify-center">
                    <span className={`text-4xl md:text-5xl font-bold bg-gradient-to-r ${pkg.color} bg-clip-text text-transparent`}>
                      {pkg.price}
                    </span>
                ...
                <CardFooter className="pt-6">
                  <Button 
                    ...
                    size="lg"
                  >
                    {pkg.popular ? 'Get Started Today' : 'Choose Plan'}
                  </Button>
                </CardFooter>
              </Card>
            ))}
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 border border-blue-500/20">
              <CardContent className="p-6 text-center">
                ...
                <h4 className="text-lg font-bold text-white mb-2">30-Day Money Back</h4>
            ...
            <Card className="bg-gradient-to-br from-purple-900/20 to-green-900/20 border border-purple-500/20">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-400 text-sm">Direct access to our expert team for consultation and ongoing support.</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-green-900/20 to-blue-900/20 border border-green-500/20">
              <CardContent className="p-6 text-center">
                ...
                <h4 className="text-lg font-bold text-white mb-2">Scalable Solutions</h4>
                <p className="text-gray-400 text-sm">Upgrade or customize your package as your business grows and evolves.</p>
              </CardContent>
            </Card>
          </div>
            ...
            <Card className="bg-gradient-to-r from-blue-900/30 via-purple-900/30 to-green-900/30 border border-gray-700/50 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                  Every business is unique. Let's discuss how we can create a tailored package that perfectly fits your specific requirements and goals.
                </p>
